...
class Headers
{
	public:
		...
		std::map<std::string, std::string>::const_iterator getBegin(void) const;
		std::map<std::string, std::string>::const_iterator getEnd(void) const;
		bool keyExists(std::string key) const;
		int keyCount(std::string key) const;
